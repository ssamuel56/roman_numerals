...
class Test < Minitest::Test
  ...
  def test_romanize_reverse_for_ix
    assert_equal(9, romanize("IX", numerals_reversed))
  end
  ...
  def test_romanize_reverse_for_cd
    assert_equal(400, romanize("CD", numerals_reversed))
  end
end
